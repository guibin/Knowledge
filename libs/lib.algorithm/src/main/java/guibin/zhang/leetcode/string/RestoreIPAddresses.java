...
public class RestoreIPAddresses {
    ...
    public List<String> restoreIpAddresses_v4(String s) {
    ...
    public void dfs_v4 (String s, List<String> result, String branch, int count) {
    ...
    public void dfs_v3(String s, String branch, List<String> res, int count){  
        if (count == 3 && isValid(s)) {  
            res.add(branch + s);  
            return;  
        }  
        for(int i = 1; i < 4 && i < s.length(); i++){  
            ...
            if (isValid(substr)){  
                dfs_v3(s.substring(i), branch + substr + '.', res, count+1);  
            }  
        }  
    }  
